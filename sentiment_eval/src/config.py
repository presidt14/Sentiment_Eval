...
def load_prompts(path: Path | str | None = None, force_reload: bool = False) -> Dict[str, Any]:
    """
...
def get_prompt_strategy(strategy_name: str = "default_sentiment") -> Dict[str, Any]:
    ...
    if strategy_name not in prompts:
        ...
        raise KeyError(f"Prompt strategy '{strategy_name}' not found. Available: {available}")
